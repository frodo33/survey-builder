...
export const buttonVariants = cva(
  `${SHADCN_BASE_CLASSES} ${CUSTOM_BASE_ADDITIONS}`,
  {
    variants: {
      variant: {
        default:
          "bg-primary-gradient text-primary-foreground dark:text-secondary-foreground shadow-sm " +
          "hover:bg-primary/90 active:bg-primary/80 " +
          "focus-visible:ring-2 focus-visible:ring-primary/30",
        destructive:
          "bg-destructive text-primary-foreground dark:text-secondary-foreground shadow-sm " +
